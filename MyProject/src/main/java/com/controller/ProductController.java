...
public class ProductController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	 ...
	 if(action.equalsIgnoreCase("Add product") ) {
			...
			String savePath = "C:\\Users\\jenil\\eclipse-workspace\\MyProject\\src\\main\\webapp\\product_image";   
		    ...
		    String savePath2 = "C:\\Users\\jenil\\eclipse-workspace\\MyProject\\src\\main\\webapp\\product_image";
	        ...
	        p.setProduct_details(request.getParameter("product_details"));
