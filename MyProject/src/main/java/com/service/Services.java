...
public class Services {
	...
	public static void sendMail(String emailid,int otp){
		final String username  = "jenilmoradiya6789@gmail.com";//Sender Email
		final String password   = "acyyhyvpcnlyejxk";//Sender Password
	...
	public static void sendMail1(String emailid,String pass){
		final String username  = "jenilmoradiya6789@gmail.com";
		final String password   = "youtube@11";
