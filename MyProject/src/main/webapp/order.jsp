            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-7">
                 ...
                 <%
                    ...
                    <% 
                       int net_price=0;
                      List<CartBean> list1=CartDao.FetchdetailsForOrders(u.getUid());
                     
                     for(CartBean c:list1){
                    	 net_price=net_price +c.getTotal_price();
                    	 ProductBean p=ProductDao.productinfo(c.getPid());
                     %>
                     
                   
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="product_image//<%=p.getProduct_image()%>">
                                    <ul class="product__item__pic__hover">
                                        <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                        <li><a href="productinfo.jsp?pid=<%=p.getPid()%>"><i class="fa fa-info"></i></a></li>
                                        <li><a href="cart.jsp"><i class="fa fa-shopping-cart"></i></a></li>
                                    </ul>
                                </div>
                                <div class="product__item__text">
                                    <h6><a href="#"><%=p.getProduct_name() %></a></h6>
                                    <h5>Price<%=c.getProduct_price() %></h5>
                                     <h5>Qauntity :</h5>
                                     <form method="post" action="Quantitychange.jsp" >
                                     <input type="hidden" name="cid" value="<%=c.getCid() %>" >
                                     <input type="number" name="product_qty" value="<%=c.getProduct_qty() %>" min="1" max="10" readonly="readonly" >
                                     </form>
                                     <h5>Total :<%=c.getTotal_price()%></h5>
